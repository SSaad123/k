...
global.mess = {
    ...
    botAdmin: 'البوت لازم يكون ادمن اول!',
    owner: 'هذا الامر للاونر بس',
    group: 'هذا الامر للقروبات بس!',
    private: 'هذا الامر في الخاص فقط!',
    bot: 'هذا الامر للبوت فقط',
    wait: 'جار التحميل...',
    linkm: 'وين الرابط؟؟',
    error: 'خطأ!',
    ban: 'تم تبنيدك من قبل الاونر من استخدام البوت.',
    nsfw: 'لول',
    banChat: 'البوت متبند في هذا القروب'
}
global.limitawal = {
    premium: "Infinity",
    free: 2,
